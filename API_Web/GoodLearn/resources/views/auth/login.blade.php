        ...
        <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
          ...
          <form class="form" method="POST" action="{{ route('loginAdmin') }}">
            ...
            <div class="card card-login card-hidden mb-3">
              <div class="card-header card-header-primary text-center" style="background: #0D2F58">
              ...
              <div class="card-footer justify-content-center">
                <button type="submit" style="color: #0D2F58" class="btn btn-primary btn-link btn-lg">{{ __('Iniciar sesion') }}</button>
              </div>
            </div>
          </form>
        </div>
