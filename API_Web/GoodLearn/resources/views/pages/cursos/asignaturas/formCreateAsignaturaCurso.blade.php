@extends('layouts.app', ['activePage' => 'table', 'titlePage' => __('Añadir asignatura al Curso: '.$curso['name'])])
          ...
          <form method="POST" action="{{route('curso.asignatura.store', $curso['id'])}}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header card-header-primary" style="background: #0D2F58">
                <h4 class="card-title" style="color: #C99255 !important">{{ __('Añadir asignatura al curso') }}</h4>
