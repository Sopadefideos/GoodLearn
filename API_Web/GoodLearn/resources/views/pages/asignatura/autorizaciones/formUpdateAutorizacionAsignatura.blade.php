@extends('layouts.app', ['activePage' => 'table', 'titlePage' => __('Modificar autorizacion a: '.$asignatura['nombre'])])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="POST" action="{{route('asignatura.autorizacion.update', $autorizacion['id'])}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
            @csrf
            @method('put')
            <div class="card ">
              <div class="card-header card-header-primary" style="background: #0D2F58">
                <h4 class="card-title" style="color: #C99255 !important">{{ __('Modificar autorizacion a la asignatura') }}</h4>
