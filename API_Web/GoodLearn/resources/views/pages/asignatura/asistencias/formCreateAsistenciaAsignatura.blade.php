@extends('layouts.app', ['activePage' => 'table', 'titlePage' => __('Añadir falta de asistencia a: '.$asignatura['nombre'])])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="POST" action="{{route('asignatura.asistencia.store', $asignatura['id'])}}" autocomplete="off" class="form-horizontal">
            @csrf
            <div class="card ">
              <div class="card-header card-header-primary" style="background: #0D2F58">
                <h4 class="card-title" style="color: #C99255 !important">{{ __('Añadir falta de asistencia a la asignatura') }}</h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="fecha_falta" id="input-name" type="date" placeholder="pepito@hotmail.com" value="" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
              </div>    
