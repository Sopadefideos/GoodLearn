...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="POST" action="{{route('asignatura.update', $asignatura['id'])}}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="nombre" id="input-name" type="text" placeholder="{{$asignatura['nombre']}}" value="" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <select class="form-control" name="usuario_id" id="input-rol" type="text">
                        ...
                        <option value="{{$profesor['id']}}" @if ($profesor['id'] == $asignatura['usuario_id'])
                        selected
                      @endif>{{$profesor['name']}}
                        </option>
                        @endforeach
