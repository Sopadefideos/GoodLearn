...
class AsignaturaController extends Controller
{
    ...
    public function content(Asignatura $asignatura)
    {
        ...
        $contenidos = Contenido::where('asignatura_id', 'like', '%' . $asignatura->id . '%')->distinct()->get()->sortBy("fecha_creacion")->groupBy('url_contenido');
        return view('pages.asignatura.asignaturas_contenido', ['asignatura' => $asignatura, 'asistencias' => $asistencias,
            'notas' => $notas, 'autorizaciones' => $autorizaciones, 'contenidos' => $contenidos]);
    }
