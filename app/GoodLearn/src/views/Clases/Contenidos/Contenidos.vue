    ...
    <ion-card-content>
     <ion-list lines="full">
      <a
        ...
        >
          <router-link
            :to="'/asignaturas/contenido/content?name='+contenido.url_contenido"
            style="text-decoration: none"
            ><ion-item>
              <ion-label style="font-size: 70%;">{{contenido.url_contenido}}</ion-label>
